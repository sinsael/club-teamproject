...
//     version 1.14.2
//     from Assets/Input/GameInputSet.inputactions
//
...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/Input/GameInputSet.inputactions".
/// </summary>
/// <remarks>
...
public partial class @GameInputSet: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        {
            ""name"": ""Game"",
            ""id"": ""8030a002-88b7-4852-b89c-5e538ac1ff8f"",
            ""actions"": [
                {
                    ""name"": ""GameStart"",
                    ""type"": ""Button"",
                    ""id"": ""530fd313-cabb-4941-95e8-187b63de4957"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""4a6e1869-7222-41f2-b98a-c91b3282004e"",
                    ""path"": ""<Keyboard>/enter"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
    ...
    ""controlSchemes"": []
        ...
        m_Game_GameStart = m_Game.FindAction("GameStart", throwIfNotFound: true);
    }

    ~@GameInputSet()
    {
        UnityEngine.Debug.Assert(!m_Game.enabled, "This will cause a leak and performance issues, GameInputSet.Game.Disable() has not been called.");
    }
    ...
    private readonly InputAction m_Game_GameStart;
    /// <summary>
    ...
    public struct GameActions
    {
        ...
        /// </summary>
        public GameActions(@GameInputSet wrapper) { m_Wrapper = wrapper; }
        /// <summary>
        /// Provides access to the underlying input action "Game/GameStart".
        /// </summary>
        public InputAction @GameStart => m_Wrapper.m_Game_GameStart;
        /// <summary>
